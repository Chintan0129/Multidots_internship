        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <table>
                <tr>
                    ...
                    <td><input type="text" id="name" name="name" class="con" required placeholder="Enter Product Name"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="number" id="price" min="0" name="price" class="con" required placeholder="Enter Product Price"></td>
                </tr>
                <tr>
                    <td><label for="rank">Rank:</label></td>
                    <td><input type="number" id="rank" min="0" name="rank" class="con" required placeholder="Enter Product Rank"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td ><textarea id="details" name="details" class="con" required placeholder="Enter Product Details" cols="30" rows="10"></textarea></td>
